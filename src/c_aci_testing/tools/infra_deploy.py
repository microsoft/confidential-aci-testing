    ...
    **kwargs,
    ...
    if not rg_exists:
        ...
        result = subprocess.run([
            ...
            "--location", location,
            "--template-file", os.path.join(bicep_template_dir, "resourceGroup.bicep"),
    ...
    if not registry_exists:
        ...
        result = subprocess.run([
            ...
            "--template-file", os.path.join(bicep_template_dir, "containerRegistry.bicep"),
    ...
    if not identity_exists:
        ...
        result = subprocess.run([
            "az", "deployment", "group", "create",
            "--resource-group", resource_group,
            "--template-file", os.path.join(bicep_template_dir, "managedIdentity.bicep"),
